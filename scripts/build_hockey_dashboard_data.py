...
def build_model(params_path: Path) -> dict[str, Any]:
    ...
    keep = {
        ...
        "searchSeed": payload["search_seed"],
        "searchTrialsTarget": payload["search_trials_target"],
        "stabilityLambda": payload["stability_lambda"],
        "generalizationWeight": payload["generalization_weight"],
        "topCandidatesEvaluated": payload["top_candidates_evaluated_on_holdout"],
